    <main class="content">
            ...
            <div class="section__body">
                <div class="hero">
                    <div class="hero__content">
                        ...
                        <img class="hero__img"
                             src="public/assets/media/img/home/hero-bg.jpg"
                             alt=""
                             width="1336" height="447" loading="lazy"
                        >
                        <h2 class="hero__subtitle"><span lang="en">Tissot Seastar</span> 1000 <span lang="en">Quartz Chronograph</span></h2>
                        <span class="hero__description">Обладают высокой степенью водонепроницаемости при давлении до 30 бар</span>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="features__content">
                        ...
                        <ul class="features__card-list">
                            <li class="features__card-item">
                                ...
                                >
                                <h3 class="features__card-title">Бесплатная доставка</h3>
                                <p class="features__card-description">Быстрая доставка или самовывоз из пунктов с оплатой после осмотра и примерки</p>
                            </li>
                            <li class="features__card-item">
                                <img
                                    class="features__card-img"
                                ...
                                >
                                <h3 class="features__card-title">Оплата после примерки</h3>
                                <p class="features__card-description">Оплата после осмотра и примерки. Просто откажитесь, если товар не подошел</p>
                            </li>
                            <li class="features__card-item">
                                <img
                                    class="features__card-img"
        ...
        <section class="section container">
            <div class="section__body">
                <div class="novelty">
                    <h2 class="novelty_title visually-hidden">Новинки в интернет-магазине "<span lang="en">TimePiece Palace</span>"</h2>
                    <div class="novelty__content">
                        <ul class="novelty__block-list">
                            <li class="novelty__block-item">
                                ...
                                >
                                <h3 class="novelty__block-title"><span lang="en">Rolex Submariner HD</span></h3>
                            </li>
                            <li class="novelty__block-item">
                                <img
                                    class="novelty__block-img"
                                    ...
                                    width="658" height="495" loading="lazy"
                                >
                                <h3 class="novelty__block-title"><span lang="en">Rosini Automatic</span></h3>
                            </li>
                        </ul>
                    </div>
                </div>
